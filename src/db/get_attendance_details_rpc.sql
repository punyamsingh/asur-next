CREATE OR REPLACE FUNCTION public.get_attendance_details(roll_no integer)
RETURNS TABLE (
    subject_id text,
    subject_name text,
    teachername text,
...
BEGIN
    ...
    GROUP BY subject.subject_id, subject.subject_name, subject.teachername, subject.classroom_id;
END;
$$ LANGUAGE plpgsql;
